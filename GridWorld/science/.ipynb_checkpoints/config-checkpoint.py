...
# GPT variables
from science.data_to_GPT import create_system_message_with_uncertainty, get_reward_function_structure_with_uncertainty, create_system_message, get_reward_function_structure
...
SYSTEM_MESSAGE_NOCERTAINTY = create_system_message(grid_height, grid_width)
FUNCTION_STRUCTURE = get_reward_function_structure_with_uncertainty(grid_width, grid_height)
FUNCTION_STRUCTURE_NOCERTAINTY = get_reward_function_structure(grid_width, grid_height)
